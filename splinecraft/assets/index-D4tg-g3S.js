...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rt,depthTest:!1,depthWrite:!1})}function Zl(){return new st({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:Rt,depthTest:!1,depthWrite:!1})}function Jl(){return new st({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zo(),fragmentShader:`
...
`].filter(Es).join(`
`)),a=Co(a),a=cc(a,t),a=uc(a,t),o=Co(o),o=cc(o,t),o=uc(o,t),a=hc(a),o=hc(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+p);const x=A+m+a,S=A+p+o,b=ac(s,s.VERTEX_SHADER,x),y=ac(s,s.FRAGMENT_SHADER,S);s.attachShader(v,b),s.attachShader(v,y),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function w(D){if(n.debug.checkShaderErrors){const I=s.getProgramInfoLog(v)||"",L=s.getShaderInfoLog(b)||"",B=s.getShaderInfoLog(y)||"",F=I.trim(),k=L.trim(),W=B.trim();let z=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,b,y);else{const ie=lc(s,b,"vertex"),fe=lc(s,y,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
`;function Rx(n){return{uGi:n.uGi,uGiSize:n.uGiSize,uGiTexel:n.uGiTexel,uGiDecode:n.uGiDecode,uGiStrength:n.uGiStrength,uSkyZenith:n.uSkyZenith,uSkyHorizon:n.uSkyHorizon,uSkySunColor:n.uSkySunColor,uSunDir:n.uSunDir,uDaylight:n.uDaylight,uSh0:n.uSh0,uSh1:n.uSh1,uSh2:n.uSh2}}const Gu=(n,e)=>({SC_CONES:n?4:6,SC_STEPS:n?14:28,SC_SPEC:n?0:1,SC_GI_SH:e==="sh"?1:0});function Ba(n,e,t=!1,i="sh",s="full",r){const a=new Float32Array(fr),o=new Float32Array(fr*3),c=new Float32Array(fr*3);for(const h of Wt)a[h.id]=h.scale,c[h.id*3]=h.albedo[0],c[h.id*3+1]=h.albedo[1],c[h.id*3+2]=h.albedo[2],h.emissive&&(o[h.id*3]=h.emissive[0],o[h.id*3+1]=h.emissive[1],o[h.id*3+2]=h.emissive[2]);const l=r?{...r,uTexLocal:{value:1},uTexOrigin:{value:new O},uFade:{value:1}}:{uAlbedo:{value:n.albedo},uNormal:{value:n.normal},uMatScale:{value:a},uMatEmissive:{value:o},uMatAlbedo:{value:c},uGi:{value:e.texture},uGiSize:{value:e.size.clone()},uGiTexel:{value:e.volume.texel},uGiDecode:{value:nl},uGiStrength:{value:1},uSkyZenith:{value:new O(.2,.36,.72)},uSkyHorizon:{value:new O(.6,.7,.82)},uSkySunColor:{value:new O(1,1,1)},uSunDir:{value:new O(0,1,0)},uTime:{value:0},uDaylight:{value:1},uSh0:{value:null},uSh1:{value:null},uSh2:{value:null},uCursor:{value:new ct(0,0,0,0)},uCursorShape:{value:0},uCursorExt:{value:new O(.5,.5,.5)},uTexLocal:{value:0},uTexOrigin:{value:new O},uFade:{value:1},uMorphBand:{value:10}},u=new Ur({color:16777215,roughness:1,metalness:0,side:Tn}),d=Gu(t,i);return s!=="full"&&(d.SC_SPEC=0),u.defines={SC_MATERIALS:fr,SC_GRASS:Hr,SC_DIRT:Gr,SC_SNOW:Vr,SC_STONE:Ps,SC_LITE:s==="full"?0:1,SC_BASIC:s==="basic"?1:0,...d},u.name="terrain-"+s,u.onBeforeCompile=h=>{Object.assign(h.uniforms,l),h.vertexShader=h.vertexShader.replace("#include <common>",`#include <common>
      ...
      if (any(isnan(gl_FragColor.rgb)) || any(isinf(gl_FragColor.rgb))) gl_FragColor.rgb = vec3(0.0);`),f.fragmentShader=f.fragmentShader.replace("#include <fog_fragment>",`
        ...
        void main() {
          ...
          #include <tonemapping_fragment>
          #include <colorspace_fragment>
        }`});this.mesh=new yt(new jo(1,32,16),e),this.mesh.frustumCulled=!1,this.mesh.renderOrder=-1e3,this.mesh.scale.setScalar(900)}}const Xr=n=>Math.round(n/P);function Ix(n,e,t,i){const s=n.index(e,t,i),r=n.hard[s];if(r===0||!vt(r))return!1;const a=n.sub[s]===0?qt:n.sub[s];return tl(a)>13}function wi(n,e,t,i){if(e<0||t<0||i<0||e>=n.nx-1||t>=n.ny-1||i>=n.nz-1)return!1;const s=n.index(e,t,i),r=n.hard[s];if(r!==0&&vt(r)){const u=n.sub[s]===0?qt:n.sub[s];if(tl(u)>13)return!1}const a=n.density,o=n.ny*n.nz,c=n.nz;let l=0;return a[s]>0&&l++,a[s+1]>0&&l++,a[s+c]>0&&l++,a[s+c+1]>0&&l++,a[s+o]>0&&l++,a[s+o+1]>0&&l++,a[s+o+c]>0&&l++,a[s+o+c+1]>0&&l++,l<6}function Lx(n,e,t,i){for(let s=t+1;s<n.ny-1;s++)if(!wi(n,e,s,i))return!1;return!0}function Bx(n,e){n.water.fill(0);const t=Xr(e),i=[],s=n.water,r=Math.min(t-1,n.ny-2);if(r<0)return 0;for(let a=0;a<n.nx-1;a++)for(let o=0;o<n.nz-1;o++)if(wi(n,a,r,o)&&Lx(n,a,r,o)){const c=n.index(a,r,o);s[c]||(s[c]=1,i.push(a,r,o))}return Nx(n,i,t)}function Ux(n,e,t,i=!0){const s=Hu(n,e,t);if(!s.plan||!i)return s.removed;const r=Uo(n,s.plan,s.plan.cells.length);return r?al(s.removed,r):s.removed}function Hu(n,e,t){const i=Xr(t),s=n.water,r=Math.max(0,e.x0-1),a=Math.max(0,e.y0-1),o=Math.max(0,e.z0-1),c=Math.min(n.nx-2,e.x1),l=Math.min(n.ny-2,e.y1,i-1),u=Math.min(n.nz-2,e.z1);let d=null;const h=[],f=new Set;for(let y=r;y<=c;y++)for(let w=a;w<=l;w++)for(let T=o;T<=u;T++){const M=n.index(y,w,T),_=wi(n,y,w,T);if(s[M]&&!_){s[M]=0,d=al(d,{x0:y,y0:w,z0:T,x1:y+1,y1:w+1,z1:T+1});continue}_&&!s[M]&&(y>0&&s[M-n.nz*n.ny]!==0||y<n.nx-2&&s[M+n.nz*n.ny]!==0||w>0&&s[M-n.nz]!==0||w<i-1&&s[M+n.nz]!==0||T>0&&s[M-1]!==0||T<n.nz-2&&s[M+1]!==0)&&!f.has(M)&&(f.add(M),h.push(y,w,T,0))}if(!h.length)return{removed:d,plan:null};const g=[],v=h.slice(),m=n.ny*n.nz,p=n.nz;let A=0;for(;A<v.length;){const y=v[A],w=v[A+1],T=v[A+2],M=v[A+3];A+=4;const _=n.index(y,w,T);g.push(_,w,M);const D=(I,L,B,F)=>{L>=i||s[F]||f.has(F)||wi(n,I,L,B)&&(f.add(F),v.push(I,L,B,M+1))};y>0&&D(y-1,w,T,_-m),y<n.nx-2&&D(y+1,w,T,_+m),w>0&&D(y,w-1,T,_-p),w<i-1&&D(y,w+1,T,_+p),T>0&&D(y,w,T-1,_-1),T<n.nz-2&&D(y,w,T+1,_+1)}const x=g.length/3,S=new Int32Array(x);for(let y=0;y<x;y++)S[y]=y;S.sort((y,w)=>g[y*3+1]-g[w*3+1]||g[y*3+2]-g[w*3+2]);const b=new Int32Array(x);for(let y=0;y<x;y++)b[y]=g[S[y]*3];return{removed:d,plan:{cells:b,done:0,contacts:h.length/4,carry:0}}}function Uo(n,e,t){const i=Math.min(e.cells.length,e.done+Math.max(0,Math.floor(t)));if(i<=e.done)return null;let s=null;const r=n.ny*n.nz,a=n.nz;for(let o=e.done;o<i;o++){const c=e.cells[o];if(!wi(n,Math.floor(c/r),Math.floor(c/a)%n.ny,c%n.nz))continue;n.water[c]=1;const l=Math.floor(c/r),u=Math.floor(c/a)%n.ny,d=c%n.nz;s=al(s,{x0:l,y0:u,z0:d,x1:l+1,y1:u+1,z1:d+1})}return e.done=i,s}function Fx(n){return Math.max(36,n.contacts*30)}function al(n,e){return n?{x0:Math.min(n.x0,e.x0),y0:Math.min(n.y0,e.y0),z0:Math.min(n.z0,e.z0),x1:Math.max(n.x1,e.x1),y1:Math.max(n.y1,e.y1),z1:Math.max(n.z1,e.z1)}:e}function Nx(n,e,t,i){const s=n.water;let r=0;const a=n.ny*n.nz,o=n.nz;for(;e.length;){const c=e.pop(),l=e.pop(),u=e.pop(),d=n.index(u,l,c),h=(f,g,v,m)=>{s[m]||g>=t||wi(n,f,g,v)&&(s[m]=1,r++,e.push(f,g,v))};u>0&&h(u-1,l,c,d-a),u<n.nx-2&&h(u+1,l,c,d+a),l>0&&h(u,l-1,c,d-o),l<t-1&&h(u,l+1,c,d+o),c>0&&h(u,l,c-1,d-1),c<n.nz-2&&h(u,l,c+1,d+1)}return r}const Ox=512,zx=Wt.length;Wt.length+1;function kx(n){const e=(t,i)=>{const s=new Qo(t,n.size,n.size,n.layers);return s.format=Ft,s.type=xt,s.colorSpace=i?it:an,s.wrapS=s.wrapT=bs,s.minFilter=yn,s.magFilter=tt,s.generateMipmaps=!0,s.anisotropy=8,s.needsUpdate=!0,s};return{albedo:e(n.albedo,!0),normal:e(n.normal,!1),swatches:n.swatches}}const Nr=16,Ts=8,Gx=`
  precision highp float;
  ...
  void main() {
    ...
    // shoreline foam only where the bed rises through the surface (the ring cells), never along a wall or a block face
    float foam = (smoothstep(0.35, 0.0, thick) * smoothstep(0.35, 0.75, n1.z * 0.5 + 0.5 + n2.x * 0.3) * vShore + smoothstep(0.35, 0.9, crest) * 0.6) * (1.0 - float(below));
    vec3 col;
    if (below) {
  ...
  varying vec3 vWorldPos;
  varying vec3 vWorldNormal;
`;function Rc(n,e,t,i){const s=new Ur({color:16777215,roughness:.85,metalness:0,side:Vt,alphaTest:.5}),r={...Rx(e),uTime:{value:0},uFadeAt:{value:26},uFadeBand:{value:8}};return s.defines={...Gu(t,i),SC_KIND:n},s.onBeforeCompile=a=>{Object.assign(a.uniforms,r),a.vertexShader=a.vertexShader.replace("#include <common>",`#include <common>
`+Zx).replace("#include <begin_vertex>",`
        ...
        #include <dithering_fragment>
        if (any(isnan(gl_FragColor.rgb)) || any(isinf(gl_FragColor.rgb))) gl_FragColor.rgb = vec3(0.0);`)},s.customProgramCacheKey=()=>`splinecraft-scatter-v2-${n}-${t}-${i}`,s.__uniforms=r,s}class Jx{constructor(e,t,i,s,r=1){this.scene=e,this.density=r,this.grassMat=Rc(pr,t,i,s),this.leafMat=Rc(Dc,t,i,s),this.bladeGeo=new zn(.09,.55,1,3),this.bladeGeo.translate(0,.275,0),this.leafGeo=new zn(.75,.75)}grassMat;leafMat;bladeGeo;leafGeo;meshes=new Map;born=new Map;retiring=[];time=0;dummy=new Nt;density=1;count=0;set(e,t,i=this.scene,s=this.time){const r=this.meshes.get(e);if(r){for(const m of r){const p=m.geometry.getAttribute("aDie");p.array.fill(s),p.needsUpdate=!0,this.retiring.push({mesh:m,at:s}),this.count-=m.count}this.meshes.delete(e)}const a=this.born.get(e)??new Map,o=new Map,c=t.length/mr;if(c===0)return;let l=0,u=0;for(let m=0;m<c;m++)t[m*mr+7]===pr?l++:u++;const d=m=>this.density>=1||t[m*mr+6]<this.density,h=(m,p,A,x)=>{if(p===0)return null;const S=A.clone(),b=new vd(S,x,p),y=new Float32Array(p),w=new Float32Array(p),T=new Float32Array(p).fill(1e9);let M=0;const _=new O(0,1,0),D=new O,I=new yi;for(let L=0;L<c;L++){const B=L*mr;if(t[B+7]!==m||!d(L))continue;const F=t[B+6];if(this.dummy.position.set(t[B],t[B+1],t[B+2]),D.set(t[B+3],t[B+4],t[B+5]),m===pr){this.dummy.quaternion.setFromAxisAngle(_,F*Math.PI*2);const z=.7+F*.7;this.dummy.scale.set(z,z,z)}else{I.setFromUnitVectors(new O(0,0,1),D),this.dummy.quaternion.copy(I).multiply(new yi().setFromAxisAngle(new O(0,0,1),F*Math.PI*2)),this.dummy.position.addScaledVector(D,.12+F*.15);const z=.75+F*.6;this.dummy.scale.set(z,z,z)}this.dummy.updateMatrix(),b.setMatrixAt(M,this.dummy.matrix),y[M]=F;const k=Math.round(F*16777216)*3+m,W=a.get(k)??s;w[M]=W,o.set(k,W),M++}return b.count=M,S.setAttribute("aSeed",new $n(y,1)),S.setAttribute("aBorn",new $n(w,1)),S.setAttribute("aDie",new $n(T,1)),b.receiveShadow=!0,b.castShadow=!1,b.frustumCulled=!1,i.add(b),this.count+=M,b},f=[],g=h(pr,l,this.bladeGeo,this.grassMat);g&&f.push(g);const v=h(Dc,u,this.leafGeo,this.leafMat);v&&f.push(v),f.length&&this.meshes.set(e,f),o.size?this.born.set(e,o):this.born.delete(e)}setFade(e,t){for(const i of[this.grassMat,this.leafMat]){const s=i.__uniforms;s.uFadeAt.value=e,s.uFadeBand.value=t}}update(e){this.time=e;for(const t of[this.grassMat,this.leafMat])t.__uniforms.uTime.value=e;if(this.retiring.length){const t=[];for(const i of this.retiring)e-i.at>.45?(i.mesh.parent?.remove(i.mesh),i.mesh.geometry.dispose()):t.push(i);this.retiring=t}}setVisible(e){for(const t of this.meshes.values())for(const i of t)i.visible=e}}const $x=`
  uniform float uTime;
